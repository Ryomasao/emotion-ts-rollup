...
var EmotionCacheContext = /* #__PURE__ */require$$0.createContext( // we're doing this to avoid preconstruct's dead code elimination in this one case
...
var withEmotionCache = function withEmotionCache(func) {
  // $FlowFixMe
  return /*#__PURE__*/require$$0.forwardRef(function (props, ref) {
    // the cache will never be null in the browser
    var cache = require$$0.useContext(EmotionCacheContext);
  ...
  withEmotionCache = function withEmotionCache(func) {
    return function (props) {
      ...
      if (cache === null) {
        ...
        return /*#__PURE__*/require$$0.createElement(EmotionCacheContext.Provider, {
          value: cache
        }, func(props, cache));
      } else {
...
var Emotion = /* #__PURE__ */withEmotionCache(function (props, cache, ref) {
  ...
  var serialized = serializeStyles(registeredStyles, undefined, typeof cssProp === 'function' || Array.isArray(cssProp) ? require$$0.useContext(ThemeContext) : undefined);
  ...
  var ele = /*#__PURE__*/require$$0.createElement(type, newProps);
  ...
  if (!isBrowser && rules !== undefined) {
    ...
    return /*#__PURE__*/require$$0.createElement(require$$0.Fragment, null, /*#__PURE__*/require$$0.createElement("style", (_ref = {}, _ref["data-emotion"] = cache.key + " " + serializedNames, _ref.dangerouslySetInnerHTML = {
      __html: rules
...
const PureButton = () => {
    return jsx("button", { children: "pureButton" }, void 0);
};

const ButtonWithCss = () => {
    return jsx("button", Object.assign({ css: style }, { children: "buttonWithCss" }), void 0);
};
const style = react.css({
    color: 'red'
});

exports.ButtonWithCss = ButtonWithCss;
